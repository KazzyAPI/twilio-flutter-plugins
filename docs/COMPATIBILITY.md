...
| iOS deployment target | 13.0 | Podspec; example app uses UIScene lifecycle (Flutter 3.47+), `FlutterPlugin` registration, and `enable-swift-package-manager: false` for CocoaPods-only Twilio SDKs |
